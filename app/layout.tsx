  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        <footer className='flex flex-col sm:flex-row gap-4 w-full items-center justify-center sm:justify-between bg-slate-200 p-4 xl:p-6 border-t border-slate-300'>
              <div className='flex h-10 sm:h-10 xl:h-14 aspect-[4/1] overflow-hidden relative'>
                <Image fill src='/imperial_college_london_logo.png' alt='Imperial College London' className='object-contain'></Image>
              </div>
              <div className='flex flex-col text-sm sm:text-base xl:text-lg sm:text-right text-center'>
